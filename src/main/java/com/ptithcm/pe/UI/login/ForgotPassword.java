...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if (username.isEmpty()) {
            JOptionPane.showMessageDialog(this, Constraints.USERNAME_IS_EMPTY, Constraints.ERROR, JOptionPane.ERROR_MESSAGE);
        } else if (email.isEmpty()) {
            JOptionPane.showMessageDialog(this, Constraints.EMAIL_IS_EMPTY, Constraints.ERROR, JOptionPane.ERROR_MESSAGE);
        } else if (ValidityUtilities.checkEmailValid(email) == 2) {
            JOptionPane.showMessageDialog(this, Constraints.EMAIL_IS_INVALID2, Constraints.ERROR, JOptionPane.ERROR_MESSAGE);
        } else if ( user == null) {
            JOptionPane.showMessageDialog(this, Constraints.USERNAME_IS_NOT_EXITS, Constraints.ERROR, JOptionPane.ERROR_MESSAGE);
        } else if (!UserDAO.getInstance().selectByUsername(username).getEmail().equals(email))
            JOptionPane.showMessageDialog(this, Constraints.EMAIL_IS_NOT_EXITS, Constraints.ERROR, JOptionPane.ERROR_MESSAGE);
        else {
            this.dispose();
