 ...
 * @author tezcap
 */
public class AddEditAnIncome extends javax.swing.JDialog {

    private static ListOfIncome panel;
     ...
     * @param modal
     */
    public AddEditAnIncome(java.awt.Frame parent, boolean modal, ListOfIncome panel, boolean flag) {
        super(parent, modal);
        this.panel = panel;
        this.flag = flag;
        initComponents();
    ...
    public AddEditAnIncome(java.awt.Frame parent, boolean modal, ListOfIncome panel, Financial f, boolean flag) {
        super(parent, modal);
        this.panel = panel;
        this.flag = flag;
        this.f = f;
    ...
    public void getDataCombobox() {
        ...
        for (Category category : CategoryDAO.getInstance().selectbyType(false)) {
...
//        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (categoryName.isEmpty())
            ...
            if (flag){
                ...
                if (result > 0) {
                    JOptionPane.showMessageDialog(this, Constraints.FINANCIAL_ADD_INCOME_SUCCESS, Constraints.LABEL_INFORMATION, JOptionPane.INFORMATION_MESSAGE);
                    panel.loadData();
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(this, Constraints.FINANCIAL_ADD_INCOME_FAIL, Constraints.LABEL_ERROR, JOptionPane.INFORMATION_MESSAGE);
                }
            } else {
                ...
                if (result > 0) {
                    JOptionPane.showMessageDialog(this, Constraints.FINANCIAL_UPDATE_INCOME_SUCCESS, Constraints.LABEL_INFORMATION, JOptionPane.INFORMATION_MESSAGE);
                    panel.loadData();
                    ...
                    JOptionPane.showMessageDialog(this, Constraints.FINANCIAL_UPDATE_INCOME_FAIL, Constraints.LABEL_ERROR, JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEditAnIncome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                if (flag) {
                    AddEditAnIncome dialog = new AddEditAnIncome(new javax.swing.JFrame(), true, panel, true);
                    ...
                    AddEditAnIncome dialog = new AddEditAnIncome(new javax.swing.JFrame(), true, panel, f, false);
                    dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                        @Override
                        public void windowClosing(java.awt.event.WindowEvent e) {
                            System.exit(0);
