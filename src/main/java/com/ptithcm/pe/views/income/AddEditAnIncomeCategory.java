 ...
 * @author tezca
 */
public class AddEditAnIncomeCategory extends javax.swing.JDialog {

    private static ListOfIncomeCategories panel;
     ...
     */
    public AddEditAnIncomeCategory(java.awt.Frame parent, boolean modal, ListOfIncomeCategories panel, boolean flag) {
        super(parent, modal);
        AddEditAnIncomeCategory.panel = panel;
        AddEditAnIncomeCategory.flag = flag;
        initComponents();
    }

    public AddEditAnIncomeCategory(java.awt.Frame parent, boolean modal, ListOfIncomeCategories panel, Category category, boolean flag) {
        super(parent, modal);
        AddEditAnIncomeCategory.panel = panel;
        AddEditAnIncomeCategory.flag = flag;
        AddEditAnIncomeCategory.category = category;
        initComponents();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (flag) {
            Category newCategory = new Category(nameCategory, false, PersonalFinanceManagement.getInstance().getUserId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEditAnIncomeCategory.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                if (flag) {
                    AddEditAnIncomeCategory dialog = new AddEditAnIncomeCategory(new javax.swing.JFrame(), true, panel, flag);
                    ...
                    AddEditAnIncomeCategory dialog2 = new AddEditAnIncomeCategory(new javax.swing.JFrame(), true, panel, category, flag);
