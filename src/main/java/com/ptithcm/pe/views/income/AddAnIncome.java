 ...
 * @author tezca
 */
public class AddAnIncome extends javax.swing.JDialog {

    /**
     * Creates new form AddNewRevenuesTypeExp
     */
    public AddAnIncome(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAnIncome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                AddAnIncome dialog = new AddAnIncome(new javax.swing.JFrame(), true);
