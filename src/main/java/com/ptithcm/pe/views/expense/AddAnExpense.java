 ...
 * @author tezca
 */
public class AddAnExpense extends javax.swing.JDialog {
    /**
     * Creates new form AddNewRevenuesTypeExp
     * @param parent
     * @param modal
     */
    public AddAnExpense(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(800, 500);
        
//        setDefaultCloseOperation(AddAnExpense.EXIT_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        setTitle(com.ptithcm.pe.utilities.Constraints.ADD_AN_EXPENSE);

        jLabel1.setFont(new java.awt.Font("Arial", Font.BOLD, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 153));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText(com.ptithcm.pe.utilities.Constraints.ADD_AN_EXPENSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAnExpense.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                AddAnExpense dialog = new AddAnExpense(new javax.swing.JFrame(), true);
