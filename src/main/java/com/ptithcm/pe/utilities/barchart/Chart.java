...
import com.ptithcm.pe.utilities.blankchart.SeriesSize;
...
public class Chart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        blankPlotChart1 = new com.ptithcm.pe.utilities.blankchart.BlankPlotChart();
        panelLegend = new javax.swing.JPanel();

        setBackground(new java.awt.Color(255, 255, 255));

        panelLegend.setOpaque(false);
        panelLegend.setPreferredSize(new java.awt.Dimension(582, 30));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart1, javax.swing.GroupLayout.DEFAULT_SIZE, 376, Short.MAX_VALUE)
                .addGap(0, 0, 0)
    ...
    private com.ptithcm.pe.utilities.blankchart.BlankPlotChart blankPlotChart1;
